    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a class="nav-link" href="<?php echo site_url('Admin/dpengaduan');?>"><i class="far fa-file-alt"></i> <span>Data Pengaduan</span></a></li>
     ...
     <td><?php echo $no++ ?></td>
         ...
         <td><?php echo $d['judul'] ?></td>
          <td class="text-center"><?php if ($d['status'] == "menunggu") :?>
             <button class="btn btn-warning"><?php echo $d['status']?></button>
             <?php elseif ($d['status'] == "proses") :?> 
             <button class="btn btn-primary"><?php echo $d['status']?></button>
             <?php elseif ($d['status'] == "selesai") :?>
             <button class="btn btn-success"><?php echo $d['status']?></button>
           <?php endif;?>
              </td>
