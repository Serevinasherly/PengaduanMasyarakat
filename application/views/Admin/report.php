      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a class="nav-link" href="<?php echo site_url('Admin/report');?>"><i class="far fa-file-alt"></i> <span>Cari data pengaduan</span></a></li>


            <li class="menu-header">USER</li>

            <li><a class="nav-link" href="<?php echo site_url('Admin/dpetugas');?>"><i class="far fa-user"></i> <span>Datapetugas</span></a></li>
       ...
       <div class="main-content">
        <section class="section">
         ...
         <div class="card-header">
            <h3>Cari Data Pengaduan</h3>
          </div>
            <div class="card shadow mb-4">
            <div class="card-body">
            <form action="<?= site_url('Admin/cari_pengaduan'); ?>" method="post">
