...
<body>
 ...
 <div class="table-responsive">
   <a href="<?php echo site_url('Admin/rp') ?>" class="btn btn-info">               
         ...
         <td>
        <a class="btn btn-danger delete-button" href="<?php echo site_url('/Admin/DoDelete/' . $d['id_petugas']); ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
        </td>
        <td>
        <a class="btn btn-warning delete-button" href="<?php echo site_url('/Admin/DoEdit/' . $d['id_petugas']); ?>" onclick="return confirm('Apakah Anda yakin ingin edit data ini?');">Edit</a>
      </td>
        </tr>
                               <?php
                                      }
